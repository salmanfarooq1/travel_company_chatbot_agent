...
class TravelServiceChatbot:
    ...
    def load_knowledge_base(self, filename, chunk_size=512):
        """Load and process company knowledge base from a text file into ChromaDB"""
        ...
        for para in paragraphs:
            ...
            ids.append(doc_id)
            metadata.append({"source": filename, "length": len(para)})
